...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  const navLinks = [
    ...
    { to: '/documents', icon: FileText, text: 'Mes cours' },
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-5 border-b border-slate-200/60">
          <div className="flex items-center gap-3">
            <img src={logo} alt="app logo" height={80} width={80} />
            <h1 className="text-sm md:text-base font-bold text-slate-900 tracking-tight">Ton assistant IA</h1>
          </div>
        ...
        <div className="px-3 py-4 border-t border-slate-200/60">
          <button
            ...
            className="cursor-pointer group flex items-center gap-3 w-full px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-red-50 hover:text-red-600 rounded-xl transition-all duration-200"
          >
            <LogOut
              size={18}
              strokeWidth={2.5}
