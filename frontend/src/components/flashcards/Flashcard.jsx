...
const Flashcard = ({ flashcard, onToggleStar }) => {
  ...
  return  <div className="relative w-full h-72" style={{ perspective: '1000px' }}>
      ...
      >
        ...
        <div
          className="absolute inset-0 w-full h-full bg-linear-to-br from-blue-500 to-blue-600 border-2 border-blue-400/60 rounded-2xl shadow-xl shadow-emerald-500/30 p-8 flex flex-col justify-between"
          style={{ 
            backfaceVisibility: 'hidden',
            WebkitBackfaceVisibility: 'hidden',
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-white/70 font-medium">
            <RotateCcw className="w-3.5 h-3.5" strokeWidth={2} />
            <span>Clique pour voir la question</span>
          </div>
        </div>
      </div>
    </div>
