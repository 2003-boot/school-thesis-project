...
const Button = ({
  ...
  const variantStyles = {
    primary: 'bg-linear-to-r from-blue-500 to-blue-500 text-white shadow-lg cursor-pointer shadow-blue-500/25 hover:from-blue-600 hover:to-blue-700 hover:shadow-xl hover:shadow-blue-500/30',
