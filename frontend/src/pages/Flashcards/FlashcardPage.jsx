...
const FlashcardPage = () => {
  ...
  const handleGenerateFlashcards = async () => {
    ...
    try {
      ...
      toast.success("Flashcards généré avec succès !");
      fetchFlashcards();
    } catch (error) {
    ...
    if (flashcards.length === 0) {
      return (
        <EmptyState
          ...
          description="Générer des flashcards à partir de ton document pour commencer l’apprentissage."
        />
      );
    }
            ...
            (flashcards.length > 0 ? (
              ...
              <Button onClick={handleGenerateFlashcards} disabled={generating}>
                {generating ? (
                  ...
                  <>
                    <Plus size={16} /> Générer des flashcards
                  </>
                )}
              </Button>
            ))}
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-neutral-600">
            Es-tu sûr de vouloir supprimer toutes les cartes mémoire pour ce document ?
