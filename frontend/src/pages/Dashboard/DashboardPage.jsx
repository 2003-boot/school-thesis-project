    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600 text-sm">Aucune donnée de dashboard disponible.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-500 text-sm">
            Suis tes progrès d’apprentissage et ton activité
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
          ...
          {dashboardData.recentActivity && (dashboardData.recentActivity.documents.length > 0 || dashboardData.recentActivity.quizzes.length > 0) ? (
                ...
                .map((activity, index) => (
                  ...
                  >
                    ...
                    {activity.link && (
                      <a
                        href={activity.link}
                        className="ml-4 px-4 py-2 text-xs font-semibold text-blue-600 hover:text-blue-700 hover:bg-emerald-50 rounded-lg transition-all duration-200 whitespace-nowrap"
                      >
                        Voir
                      </a>
                    )}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-slate-600">Pas encore d’activité récente.</p>
