  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-sm font-medium text-slate-500">
            {answeredCount} répondu
          </span>
        </div>
        <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
          <div 
            className="absolute inset-y-0 left-0 bg-linear-to-r from-blue-500 to-blue-500 rounded-full transition-all duration-500 ease-out"
      ...
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-6 mb-8">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-blue-50 to-blue-60 border border-blue-200 rounded-xl mb-6">
          ...
          return (
            <button
              ...
              className={`w-8 h-8 rounded-lg font-semibold text-xs transition-all duration-200 ${
                isCurrent
                  ? 'bg-linear-to-r from-blue-500 to-blue-600 text-white shadow-lg shadow-blue-500/25 scale-110'
                  : isAnsweredQuestion
